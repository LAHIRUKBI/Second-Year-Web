...
<html>
<head>
    <title>Disapproved Property Details</title>
    <link rel="stylesheet" href="JY/admi_disapproved_propety_details.css">
...
<h1>Disapproved Property Details</h1><br><br>
...
<table style="width:100%">
  ...
  <c:forEach var="property" items="${dpdetails}">
    <tr>
        ...
        <td>
            <a href="admin_Approve_property.jsp?pid=${property.getPid()}&title=${property.getTitle()}&type=${property.getType()}&location=${property.getLocation()}&description=${property.getDescription()}&owner=${property.getOwnerName()}&phone=${property.getOwnerPhone()}&email=${property.getEmail()}&price=${property.getPrice()}&totalcost=${property.getTotalcost()}&states=${property.getStates()}&discount=${property.getDiscount()}">
